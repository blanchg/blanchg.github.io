...
( function ( THREE ) {
	...
	THREE.GPUPicker.prototype._addElementID = function(object, baseId) {
		...
		if (object.geometry) {
			...
			var pointSize = object.material.uniforms.size?object.material.uniforms.size.value : 0.01;
			var pointScale = object.material.uniforms.scale?object.material.uniforms.scale.value : 400;
			var linewidth = object.material.uniforms.linewidth?object.material.uniforms.linewidth.value : 1;
			...
			object.material.setPointScale(pointScale); //this.renderer.getSize().height*this.renderer.getPixelRatio()/2
